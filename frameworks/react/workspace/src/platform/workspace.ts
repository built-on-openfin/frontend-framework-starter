 ...
 * @param logMessage A function to log messages during initialization.
 */
export async function initializeWorkspacePlatform(
	platformSettings: PlatformSettings,
	logMessage: (log: string) => void,
): Promise<void> {
 ...
 * @param logMessage A function to log messages during initialization.
 */
export async function initializeWorkspaceComponents(
	platformSettings: PlatformSettings,
	...
	// Register with dock and show it
 ...
 */
export async function getManifestCustomSettings(): Promise<{
	platformSettings: PlatformSettings;
