# OpenFin Web Intents Starter - React

A version of the web-starter / [web-interop-support-context-and-intents](https://github.com/built-on-openfin/web-starter/tree/main/how-to/web-interop-support-context-and-intents) built in React.
